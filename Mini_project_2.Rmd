...
rep <- rep + 
      ...
      scale_fill_gradient(low="mistyrose1", high="brown3", trans = "log",
                          name = "State Donations", breaks = c(2980, 162755, 8886110.521),
                           labels = c("3000", "170000","9000000"))+
      theme(legend.title = element_text(colour="red4", size=10, face="bold"))
...
dem <- dem + 
      ...
      scale_fill_gradient(low="lightblue1", high="royalblue4", trans = "log",
                          name = "State Donations", breaks = c(2980, 59874, 1202604,24000000),
                          labels = c("3000", "60000","1200000","24000000"))+
      theme(legend.title = element_text(colour="navy", size=10, face="bold"))
